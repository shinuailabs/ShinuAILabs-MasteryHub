Chapter 9 — QA Copilot: Multi-Source RAG Plan                                   
 ...
 Build QA Copilot in Part_09_Project_QACopilot/ that lets a tester ask        
 ...
 - Part_08_RAG/Advance_RAG_EXPLAIN/lib/embeddings.py — bge-m3 dual-vector
 encoder. Reuse as-is.
 - Part_08_RAG/Advance_RAG_EXPLAIN/lib/chunking.py — assemble_document +
 chunk_test_case. Use for vwo_testcases ingest.
 - Part_08_RAG/Advance_RAG_EXPLAIN/ingest.py — Qdrant collection bootstrap
 (named-vectors config), upsert pattern, payload shape. Pattern reused per
 collection.
 - Part_08_RAG/Advance_RAG_EXPLAIN/app.py — Groq client init, GROQ_MODEL env,
  system prompt structure. Port to FastAPI handler.
 - Part_08_RAG/Advance_RAG_EXPLAIN/static/claude.css — color tokens;
 translate to Tailwind theme extension.
 - Part_07_AI_Agent_VIBE_Coding/backend/main.py — FastAPI + CORS + Groq
 client wiring.
 - Part_07_AI_Agent_VIBE_Coding/frontend/ — Vite+TS+Tailwind+Router skeleton,
 ...
 - Reused libs: pointer to Part_08_RAG/Advance_RAG_EXPLAIN/lib/ for the
