...
- `Part_08_RAG/Advance_RAG_EXPLAIN/lib/embeddings.py` → `backend/lib/embeddings.py` (BGE-M3 dense+sparse)
- `Part_08_RAG/Advance_RAG_EXPLAIN/lib/chunking.py` → `backend/lib/chunking_text.py` (row-aware test-case chunker)
- `Part_08_RAG/Advance_RAG_EXPLAIN/lib/rerank.py` → `backend/lib/reranker.py` (BGE-Reranker-v2-m3)
- `Part_08_RAG/Advance_RAG_EXPLAIN/lib/store.py` → `backend/lib/qdrant_store.py` (extended for 5-collection bootstrap and per-collection RRF)
