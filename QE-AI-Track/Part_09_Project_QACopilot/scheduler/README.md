...
- Reads scheduling config from `Part_09_Project_QACopilot/.env` via
...
<dict>
  ...
  <string>/Users/YOU/path/to/Part_09_Project_QACopilot</string>
  <key>ProgramArguments</key>
  <array>
    <string>/Users/YOU/path/to/Part_09_Project_QACopilot/.venv/bin/python</string>
    <string>-m</string>
  ...
  <string>/Users/YOU/path/to/Part_09_Project_QACopilot/data/_launchd.out.log</string>
  <key>StandardErrorPath</key>
  <string>/Users/YOU/path/to/Part_09_Project_QACopilot/data/_launchd.err.log</string>
</dict>
</plist>
```
...
[Service]
Type=oneshot
WorkingDirectory=/opt/qacopilot/Part_09_Project_QACopilot
ExecStart=/opt/qacopilot/Part_09_Project_QACopilot/.venv/bin/python -m scheduler.run --once
User=qacopilot
```
