...
EnvironmentFile=/opt/qacopilot/Part_09_Project_QACopilot/.env
ExecStart=/opt/qacopilot/Part_09_Project_QACopilot/.venv/bin/uvicorn \
...
```bash
cd /opt/qacopilot/Part_09_Project_QACopilot/frontend
...
server {
    ...
    root /opt/qacopilot/Part_09_Project_QACopilot/frontend/dist;
    index index.html;
    ...
    location /KT/ {
        alias /opt/qacopilot/Part_09_Project_QACopilot/KT/;
    }
}
```
