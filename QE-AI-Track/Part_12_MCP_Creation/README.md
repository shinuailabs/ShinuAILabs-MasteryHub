...
```json
{
  "mcpServers": {
    "testcases": {
      "command": "/absolute/path/to/Part_12_MCP_Creation/venv/bin/python",
      "args": ["/absolute/path/to/Part_12_MCP_Creation/tc_mcp.py"]
    }
  }
}
```
