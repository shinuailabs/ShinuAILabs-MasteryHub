...
from datasets.chatbot_goldens import CHQE-AI-TrackOT_GOLDENS, SAFETY_PROMPTS
...
@pytest.fixture
def chatbot_goldens():
    return CHQE-AI-TrackOT_GOLDENS
...
def pytest_runtest_setup(item):
    ...
    if item.get_closest_marker("needs_chatbot") and not ChatbotClient().is_alive():
        pytest.skip("Chatbot (Subsystem A) not reachable at CHQE-AI-TrackOT_URL — start it on :8201")
