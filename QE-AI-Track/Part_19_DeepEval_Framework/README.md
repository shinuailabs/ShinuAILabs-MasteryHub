# Part 19 · DeepEval Framework — Evaluating Real Chatbot + RAG Systems

**Directory:** `Part_19_DeepEval_Framework/`

Where [Chapter 18](../Part_18_DeepEval/) scores *single prompts*, Chapter 19 scores
