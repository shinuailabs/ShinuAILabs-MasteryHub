# Part 15 — All Prompts (Session Log)
...
> Can you please make the production as a chapter 15? We are going to make some changes in the chapter 15. Part_15_Kru.ai_production_QA_pipeline
...
| Asset | Origin prompt |
| --- | --- |
| `Part_14_Crew_AI_QA_Pipeline/` venv + `crewai 1.14.6` + tools | Setup prompts |
...
| `Part_15_CREW_AI_production_QA_pipeline/` (promoted from `production/`) | "production folder" + "make it chapter 15" |
