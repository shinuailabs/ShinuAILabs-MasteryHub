...
MAX_RETRY = 3
BASE_URL = "https://api.shinuailabs.com"
...
firstName = "Shinoj"          # works in Python but breaks PEP 8
retryCount = 3
...
heading = "Shinu AI Labs Blueprint"
print(heading)
...
strName = "Shinoj"            # don't do this in Python
iCount = 3
bIsValid = True
